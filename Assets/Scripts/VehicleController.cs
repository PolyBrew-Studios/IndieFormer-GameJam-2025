...
public class VehicleController : MonoBehaviour
{
    ...
    private Transform[] _tireVisuals = new Transform[3];
    ...
    private void UpsideDownCheck()
    {
        ...
        // Check velocity
        if (_rigidbody.linearVelocity.magnitude > flipVelocityTheshold)
            return;
    ...
    {
        _rigidbody.linearVelocity = rb.linearVelocity;
        _rigidbody.angularVelocity = rb.angularVelocity;
        _rigidbody.angularDamping = rb.angularDamping;
    }
